...
ggsave(plot = plt, filename = here("fig/figures/degree/sp_situ.png"), width = 12, height = 6)
```
...
plt <- a + b + plot_layout(widths = c(4, 1))
ggsave(plot = plt, filename = here("fig/figures/degree/rd_situ.png"), width = 12, height = 6)
```
...
plt <- a + b + plot_layout(widths = c(4, 1))
ggsave(plot = plt, filename = here("fig/figures/strength/sp_situ.png"), width = 12, height = 6)
```
...
plt <- a + b + plot_layout(widths = c(4, 1))
ggsave(plot = plt, filename = here("fig/figures/strength/rd_situ.png"), width = 12, height = 6)
```
