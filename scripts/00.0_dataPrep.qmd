...
```{r load-packages}
# First install the package from GitHub (do this in the console, not the script)
# remotes::install_github("kaijagahm/vultureUtils")
# devtools::install_github("kaijagahm/vultureUtils")
library(vultureUtils)
library(sf)
library(tidyverse)
library(move) # the R package that allows you to download Movebank data through R instead of manually
library(feather)
library(readxl)
library(elevatr)
library(here)
...
```{r region-masking}
mask <- sf::st_read(here("data/CutOffRegion.kml"))
