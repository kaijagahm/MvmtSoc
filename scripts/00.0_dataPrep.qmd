...
# Add the Nili_id
ww <- read_excel("data/raw/whoswho_vultures_20230920_new.xlsx", sheet = "all gps tags")[,1:35] %>%
...
age_sex <- read_excel("data/raw/whoswho_vultures_20230920_new.xlsx", sheet = "all gps tags")[,1:35] %>%
