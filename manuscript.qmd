...
Individual vultures interacted with significantly more unique others over the course of a season than expected by chance (i.e. observed degree values compared to the distribution of degree values obtained from networks created from the wrap-around data), across all seasons and social situations. However, individuals' strength did not differ from random.
...
There was a significant relationship between how vultures used space and how many other individuals they encountered in flight. Vultures that consistently ranged widely encountered more others in flight, while those that concentrated their movement in smaller home ranges and smaller proportional core areas flew with fewer others. Similarly, there was a marginally significant positive relationship between space use and degree deviation in the co-feeding network as well. By contrast, vultures with smaller home ranges/proportionally smaller core areas had a co-roosting degree that deviated more from chance than those with larger home ranges/proportionally larger core areas.
...
Vultures with greater roost diversification, had, overall, smaller degree deviations than those with smaller roost diversification, though the effect size was small.
