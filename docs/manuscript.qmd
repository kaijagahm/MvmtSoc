...
After this cleaning, the data used for social network analysis contained \[NUMBER\] of unique vultures in total. Table \[NUMBER\] shows the number of individuals included in the social networks for each season.
